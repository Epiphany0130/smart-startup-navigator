...
import static com.gyqstd.smartstartupnavigator.constant.Prompt.CREATIVE_STAGE_SYSTEM_PROMPT;
...
@Component
@Slf4j
public class EntrepreneurshipTypes {

    // 注入 ChatClient，支持多轮对话
    private final ChatClient chatClient;

    public EntrepreneurshipTypes(ChatModel dashscopeChatModel) {
        // 初始化基于内存的对话记忆
        ChatMemory chatMemory = new InMemoryChatMemory();

        chatClient = ChatClient.builder(dashscopeChatModel)
                .defaultSystem(ENTREPRENEURSHIP_TYPES_SYSTEM_PROMPT)
                .defaultAdvisors(
